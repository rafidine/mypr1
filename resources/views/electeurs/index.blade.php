...
@section('nom', 'Liste parrainage')

@section('contents')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="mb-0">Liste des Parrains</h1>
        <a href="{{ route('electeurs.create') }}" class="btn btn-primary" style="background-color: yellow; color: black;">Ajoutez Parrain</a>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{ route('electeurs.edit', $rs->id) }}" type="button" class="btn btn-warning">Modifier</a>
