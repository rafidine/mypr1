...
<body class="bg-gradient-success"> <!-- Changer bg-gradient-primary en bg-gradient-success pour la couleur verte -->
  <div class="container">
    <!-- Outer Row -->
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="{{ asset('admin_assets/img/8.jpg') }}" alt="Nom du profil 3" class="profile-image">
              </div>
              <div class="col-lg-7">
                <div class="p-5">
                  ...
                  <form action="{{ route('register.save') }}" method="POST" class="user">
                    ...
                    <button type="submit" class="btn btn-success btn-user btn-block">Register Account</button> <!-- Changer btn-primary en btn-success pour le bouton de connexion -->
                  </form>
                  <hr>
                  <div class="text-center">
                    <a class="small" href="{{ route('login') }}">tu as deja un compte? Login!</a>
                  </div>
                </div>
              </div>
            </div>
